...
# Rotate and capture first image
...
# Translate and capture second image
transform2.translate(t_0)
v_pos2 = transform2.transform_pts(v_pos1)
img2 = render_object(v_pos1, v_clr, t_pos_idx, plane_h, plane_w, res_h, res_w, focal, eye, up, target)

# Translate and capture third image
